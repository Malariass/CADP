...
def obtener_ultimos_10_digitos(numero_grande):
    return numero_grande % 10**10

# Ejemplo de uso
resultado_grande = solucionarRompecabezas(2023**100)  # Resultado grande
ultimos_10_digitos = obtener_ultimos_10_digitos(resultado_grande)
print(ultimos_10_digitos)