...
sueldo_fijo = 200000
ventas_realizadas = float(input("ingrese las monto total de las ventas realizadas este mes: "))
sueldo = sueldo_fijo + ((ventas_realizadas / 100)*16)
print(f"el sueldo del vendedor es: {sueldo}")
